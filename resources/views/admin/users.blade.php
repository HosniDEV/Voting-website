                        ...
                        <div class="flex justify-between">
                          ...
                          <table class="w-full mt-5">
                            <thead class=" bg-slate-400 ">
                                <th class=" text-start py-2 px-2 w-40">user name</th>
                                <th class=" text-start py-2 px-2 ">email</th>
                                <th class=" text-start py-2 px-2">created at </th>
                            </thead>
                            <tbody class="bg-slate-300">
                            @foreach ($usess as $user)
                            <tr class="border-b-2  ">
                                <td class='py-2 px-2  '>{{$user->name}}</td>
                                <td class='py-2 px-2  '>{{$user->email}}</td>
                                <td class='py-2 px-2  '>{{$user->created_at}}</td>
                              </tr>
                            @endforeach
